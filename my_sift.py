...
class MY_SIFT:
    ...
    def computeKeypointsAndDescriptors(self,sigma=1.6, num_intervals=3, image_border_width=5):
        ...
        print("remove_duplicate_key_points")
        keypoints = self.convert_key_points_to_input_image_size(keypoints)
        print("convert_key_points_to_input_image_size")
    ...
    def findScaleSpaceExtrema(self, gaussian_images, dog_images, num_intervals, sigma, image_border_width, contrast_threshold=0.1):
