...
######################################Task 1 noise filters and stuff#################################
    ...
    def thresholding(self,image):
        ...
        if image is None:
            ...
            if self.ui.combo_thersholding.currentIndex()==0:
                ...
                final_img = local_thresholding_1(gray,self.ui.slider_1.value(),self.ui.slider_2.value(),
            ...
            # Applying the threshold on the image whether it is calculated or given by the user according to the previous condition
                ...
                final_img=global_thresholding_1(gray,self.ui.slider_1.value())
